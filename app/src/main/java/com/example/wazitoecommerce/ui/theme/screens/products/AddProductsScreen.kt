...
fun AddProductsScreen(navController:NavHostController){
    Column(
        ...
        TopAppBar(title = { Text(text = "Add a Service", fontWeight = FontWeight.ExtraBold, color = Color.White) },
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "Name of Service") },
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "Price per Kilogram") },
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Text)
        )
